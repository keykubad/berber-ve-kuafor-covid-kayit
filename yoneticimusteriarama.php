...
$toplam_icerik_sayisi = mysqli_num_rows(mysqli_query($conn,"select * from musteriler WHERE isimsoyisim like '%".$ara_post."%' or tckimlik like '%".$ara_post."%' or tarih like '%".tarih_ara($ara_post)."%' or telefon like '%".$ara_post."%'"));
$limit = 10;
...
$cek	= mysqli_query($conn,"select * from musteriler WHERE isimsoyisim like '%".$ara_post."%' or tckimlik like '%".$ara_post."%' or tarih like '%".tarih_ara($ara_post)."%' or telefon like '%".$ara_post."%' LIMIT ".$baslangic.",".$limit."");
?>  
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-rep-plugin">
                                            <div class="table-responsive mb-0" data-pattern="priority-columns">
												...
												<a type="button" class="btn btn-warning waves-effect waves-light" href='yonetici.php?sayfa=yoneticimusteriliste'>GERİ GİT</a>
                                            </div>
