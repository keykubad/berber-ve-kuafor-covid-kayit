                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Yönetici Müşteri Düzenleme</h4>
                                        <p class="card-title-desc">Yönetici müşteri Düzenlemesini bu alandan yapabilirsiniz.</p>
                                            ...
                                            <label>Berber</label>
                                                ...
                                                <select name="berber" class="form-control" required />
                                                    <option>Berber seçimi</option>
													<?php
															$berberbul	=mysqli_query($conn,"select * from kullanicilar where yetki='2'");
																while($aldir=mysqli_fetch_assoc($berberbul)){
													?>
                                                    <option value="<?php echo $aldir["id"]; ?>" <?php if($aldir["id"]===$cek["berber"]) { echo "selected"; } ?> ><?php echo $aldir["kurumadi"]; ?></option>
...
$timestamp 		= date("Y-m-d H:i:s");
		...
		dogumyil='$dogumyil', berber='$berber',tarih='".$cek["tarih"]."' WHERE id='".$idal."'");
